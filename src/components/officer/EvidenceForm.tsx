...
import { Camera, Upload, Briefcase, X } from "lucide-react";
            ...
            <div className="mt-2 border-2 border-dashed rounded-md p-6 text-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Upload photos or documents related to this evidence
                </p>
                <Button
                  type="button"
                  variant="outline"
                  ...
                  {selectedFiles.map((file, index) => (
                    <div key={index} className="relative group">
                      {file.type.startsWith("image/") && previewUrls[index] ? (
                        ...
                        <div className="relative aspect-square rounded-md overflow-hidden border bg-muted flex items-center justify-center">
                          <div className="flex flex-col items-center p-2 text-center">
                            <Briefcase className="h-8 w-8 text-muted-foreground mb-1" />
